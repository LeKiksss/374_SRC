...
module tb_phase2_store;
    ...
    task show_state;
        ...
        begin
            $display("[%0t] %s BUS=%h PC=%h IR=%h MAR=%h MDR=%h MEM=%h R6=%h Zlow=%h",
                $time, label, BusMuxOut, PC, IR, MAR, MDR, MemoryData, R6, Zlow);
        end
    endtask
    ...
    always @(posedge Clock) begin
        ...
        case (Present_state)
            ...
            S_T6_1: begin show_state("T6"); Present_state = S_T7_1; end
            S_T7_1: begin show_state("T7"); Present_state = S_T8_1; end
            S_T8_1: begin show_state("T8"); Present_state = S_T9_1; end
            S_T9_1: begin
                show_state("T9");
            ...
            S_T6_2: begin show_state("T6"); Present_state = S_T7_2; end
            S_T7_2: begin show_state("T7"); Present_state = S_T8_2; end
            S_T8_2: begin show_state("T8"); Present_state = S_T9_2; end
            S_T9_2: begin
                show_state("T9");
