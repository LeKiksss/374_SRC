...
module tb_shr;
    ...
    always @(Present_state) begin
        ...
        Mdatain=0;
        case (Present_state)
            Reg_load1a: begin Mdatain=32'hF000_0008; Read=1; MDRin=1; end  // R0 <- value to shift
            Reg_load1b: begin MDRout=1; Rin[0]=1; end
            Reg_load2a: begin Mdatain=32'd2; Read=1; MDRin=1; end         // R4 <- shift count 2
            Reg_load2b: begin MDRout=1; Rin[4]=1; end
            T0: begin PCout=1; MARin=1; IncPC=1; Zin=1; end
            T1: begin Zlowout=1; PCin=1; Read=1; MDRin=1; Mdatain=32'h11870000; end  // shr R7,R0,R4
            T2: begin MDRout=1; IRin=1; end
            T3: begin Rout[0]=1; Yin=1; end
            T4: begin Rout[4]=1; SHR=1; Zin=1; end   // A=Y=R0, B=bus=R4 (shamt)
