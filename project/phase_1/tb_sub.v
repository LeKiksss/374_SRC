// Testbench for sub R2, R5, R6. Matches the add control sequence with SUB asserted in T4.
`timescale 1ns/10ps
module tb_sub;
    reg Clock, Clear;
    reg [15:0] Rin, Rout;
    ...
    always @(Present_state) begin
        ...
        Mdatain=0;
        case (Present_state)
            Reg_load1a: begin Mdatain=32'h45; Read=1; MDRin=1; end
            Reg_load1b: begin MDRout=1; Rin[5]=1; end
            Reg_load2a: begin Mdatain=32'h34; Read=1; MDRin=1; end
            Reg_load2b: begin MDRout=1; Rin[6]=1; end
            T0: begin PCout=1; MARin=1; IncPC=1; Zin=1; end
            T1: begin Zlowout=1; PCin=1; Read=1; MDRin=1; Mdatain=32'h112E0000; end  // sub R2,R5,R6
            T2: begin MDRout=1; IRin=1; end
            T3: begin Rout[5]=1; Yin=1; end
            T4: begin Rout[6]=1; SUB=1; Zin=1; end
