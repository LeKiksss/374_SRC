// ROR instruction testbench: ror R7, R0, R4 (ROR in T4)
`timescale 1ns/10ps
module tb_ror;
    reg Clock, Clear;
    reg [15:0] Rin, Rout;
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            T1: begin Zlowout=1; PCin=1; Read=1; MDRin=1; Mdatain=32'h11930000; end  // ror R7,R0,R4
            T2: begin MDRout=1; IRin=1; end
            T3: begin Rout[0]=1; Yin=1; end
            T4: begin Rout[4]=1; ROR=1; Zin=1; end
