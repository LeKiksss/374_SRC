// ROL instruction testbench: rol R7, R0, R4 (ROL in T4)
`timescale 1ns/10ps
module tb_rol;
    reg Clock, Clear;
    reg [15:0] Rin, Rout;
    ...
    always @(Present_state) begin
        ...
        Mdatain=0;
        case (Present_state)
            Reg_load1a: begin Mdatain=32'hF000_0008; Read=1; MDRin=1; end
            ...
            T1: begin Zlowout=1; PCin=1; Read=1; MDRin=1; Mdatain=32'h11970000; end  // rol R7,R0,R4
            T2: begin MDRout=1; IRin=1; end
            T3: begin Rout[0]=1; Yin=1; end
            T4: begin Rout[4]=1; ROL=1; Zin=1; end
