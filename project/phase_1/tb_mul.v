// Testbench for mul R3, R1. After the multiply, the low word goes to LO (T5) and the high word to HI (T6).
`timescale 1ns/10ps
module tb_mul;
    reg Clock, Clear;
    reg [15:0] Rin, Rout;
    ...
    parameter Default=4'b0000, Reg_load1a=4'b0001, Reg_load1b=4'b0010, Reg_load2a=4'b0011,
              Reg_load2b=4'b0100, T0=4'b0111, T1=4'b1000, T2=4'b1001, T3=4'b1010, T4=4'b1011, T5=4'b1100, T6=4'b1101;
    ...
    always @(Present_state) begin
        ...
        Mdatain=0;
        case (Present_state)
            Reg_load1a: begin Mdatain=32'd100; Read=1; MDRin=1; end   // R3 <- 100
            Reg_load1b: begin MDRout=1; Rin[3]=1; end
            Reg_load2a: begin Mdatain=32'd7; Read=1; MDRin=1; end     // R1 <- 7
            Reg_load2b: begin MDRout=1; Rin[1]=1; end
            T0: begin PCout=1; MARin=1; IncPC=1; Zin=1; end
            T1: begin Zlowout=1; PCin=1; Read=1; MDRin=1; Mdatain=32'h11980000; end  // mul R3,R1
            T2: begin MDRout=1; IRin=1; end
            T3: begin Rout[3]=1; Yin=1; end
            T4: begin Rout[1]=1; MUL=1; Zin=1; end
