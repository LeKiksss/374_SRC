// NOT instruction testbench: not R4, R7 — T3 R7out,NOT,Zin; T4 Zlowout,R4in
`timescale 1ns/10ps
module tb_not;
    reg Clock, Clear;
    reg [15:0] Rin, Rout;
    ...
    always @(Present_state) begin
        ...
        Mdatain=0;
        case (Present_state)
            Reg_load1a: begin Mdatain=32'h0000_00FF; Read=1; MDRin=1; end  // R7 <- 0x000000FF
            Reg_load1b: begin MDRout=1; Rin[7]=1; end
            T0: begin PCout=1; MARin=1; IncPC=1; Zin=1; end
            T1: begin Zlowout=1; PCin=1; Read=1; MDRin=1; Mdatain=32'h11880000; end  // not R4,R7
            T2: begin MDRout=1; IRin=1; end
            T3: begin Rout[7]=1; NOT_op=1; Zin=1; end  // B=R7, NOT -> Z = ~B
            T4: begin Zlowout=1; Rin[4]=1; end        // R4 <- not(R7) = 0xFFFFFF00
        endcase
    end
endmodule
